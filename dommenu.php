...
<body>
    ...
    <div class="card-container">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/dom1.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">dom1</h5>
                <p class="card-price">KES 1,000</p>
                <input type="hidden" name="product" value="dom1">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/dom2.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">dom2</h5>
                <p class="card-price">KES 1,050</p>
                <input type="hidden" name="product" value="dom2">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/dom3.jpg" alt="Card image cap">
                </div>
                <h5 class="card-title">dom3</h5>
                <p class="card-price">KES 2550</p>
                <input type="hidden" name="product" value="dom3">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/dom4.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">dom4</h5>
                <p class="card-price">KES 3500</p>
                <input type="hidden" name="product" value="dom4">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/dom5.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">dom5</h5>
                <p class="card-price">KES 1250</p>
                <input type="hidden" name="product" value="dom5">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/dom6.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">dom6</h5>
                <p class="card-price">KES 4,000</p>
                <input type="hidden" name="product" value="dom6">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/dom7.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">dom7</h5>
                <p class="card-price">KES 3,000</p>
                <input type="hidden" name="product" value="dom7">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/dom8.jpg" alt="Card image cap">
                </div>
                <h5 class="card-title">dom8</h5>
                <p class="card-price">KES 1500</p>
                <input type="hidden" name="product" value="dom8">
        ...
        <form action="" method="post">
            <div class="card">
                ...
                <h5 class="card-title">dom9</h5>
                <p class="card-price">KES 2,000</p>
                <input type="hidden" name="product" value="dom9">
