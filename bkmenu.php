...
<body>
    ...
    <div class="card-container">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/b1.jpg" alt="Card image cap">
                </div>
                <h5 class="card-title">burger meal</h5>
                <p class="card-price">KES 1,000</p>
                <input type="hidden" name="product" value="burger meal">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/b2.jpg" alt="Card image cap">
                </div>
                <h5 class="card-title">Triple burger</h5>
                <p class="card-price">KES 2550</p>
                <input type="hidden" name="product" value="Triple burger">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/b3.jpg" alt="Card image cap">
                </div>
                <h5 class="card-title">Fries</h5>
                <p class="card-price">KES 3500</p>
                <input type="hidden" name="product" value="Fries">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/b6.avif" alt="Card image cap">
                </div>
                <h5 class="card-title">Burger combo</h5>
                <p class="card-price">KES 1250</p>
                <input type="hidden" name="product" value="Burger combo">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/b7.jpg" alt="Card image cap">
                </div>
                <h5 class="card-title">burger&Fries combo</h5>
                <p class="card-price">KES 4,000</p>
                <input type="hidden" name="product" value="burger&Fries combo">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/b8.webp" alt="Card image cap">
                </div>
                <h5 class="card-title">cheesy burger</h5>
                <p class="card-price">KES 3,000</p>
                <input type="hidden" name="product" value="cheesy burger7">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/b9.jpg" alt="Card image cap">
                </div>
                <h5 class="card-title">Meaty burger</h5>
                <p class="card-price">KES 1500</p>
                <input type="hidden" name="product" value="Meaty burger">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/b10.avif" alt="Card image cap">
                </div>
                <h5 class="card-title">Bacon burger</h5>
                <p class="card-price">KES 2,000</p>
                <input type="hidden" name="product" value="Bacon burger">
