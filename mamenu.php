...
<body>
    ...
    <div class="card-container">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/sw1.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Breakfast platter</h5>
                <p class="card-price">KES 1,000</p>
                <input type="hidden" name="product" value="Breakfast platter">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/sw2.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">chicken biryiani</h5>
                <p class="card-price">KES 1,050</p>
                <input type="hidden" name="product" value="chicken biryiani">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/sw3.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">biryiani</h5>
                <p class="card-price">KES 2550</p>
                <input type="hidden" name="product" value="biryiani">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/sw4.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">pilau(kachumbari)</h5>
                <p class="card-price">KES 3500</p>
                <input type="hidden" name="product" value="pilau(kachumbari)">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/sw5.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">beef pilau</h5>
                <p class="card-price">KES 1250</p>
                <input type="hidden" name="product" value="beef pilau">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/sw6.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">pilau</h5>
                <p class="card-price">KES 4,000</p>
                <input type="hidden" name="product" value="pilau">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/sw7.webp" alt="Card image cap">
                </div>
                <h5 class="card-title">mutton pilau</h5>
                <p class="card-price">KES 3,000</p>
                <input type="hidden" name="product" value="mutton pilau">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/sw8.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">chicken pilau</h5>
                <p class="card-price">KES 1500</p>
                <input type="hidden" name="product" value="chicken pilau">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/sw9.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">swahili breakfast buffet</h5>
                <p class="card-price">KES 2,000</p>
                <input type="hidden" name="product" value="swahili breakfast buffet">
