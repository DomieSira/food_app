...
<body>
    ...
    <div class="card-container">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/l9.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Fries1</h5>
                <p class="card-price">KES 1,000</p>
                <input type="hidden" name="product" value="Fries1">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/l8.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Fries2</h5>
                <p class="card-price">KES 1,050</p>
                <input type="hidden" name="product" value="Fries2">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/l7.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Fries3</h5>
                <p class="card-price">KES 2550</p>
                <input type="hidden" name="product" value="Fries3">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/l6.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Fries4</h5>
                <p class="card-price">KES 3500</p>
                <input type="hidden" name="product" value="Fries4">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/l5.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Fries5</h5>
                <p class="card-price">KES 1250</p>
                <input type="hidden" name="product" value="Fries5">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/l4.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Fries6</h5>
                <p class="card-price">KES 4,000</p>
                <input type="hidden" name="product" value="Fries6">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/l3.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Fries7</h5>
                <p class="card-price">KES 3,000</p>
                <input type="hidden" name="product" value="Fries7">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/l2.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Fries8</h5>
                <p class="card-price">KES 1500</p>
                <input type="hidden" name="product" value="Fries8">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/l1.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Fries9</h5>
                <p class="card-price">KES 2,000</p>
                <input type="hidden" name="product" value="Fries9">
