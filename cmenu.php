...
<body>
    ...
    <div class="card-container">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/c1.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">combo meal</h5>
                <p class="card-price">KES 1,000</p>
                <input type="hidden" name="product" value="combo meal">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/c2.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">breakfast</h5>
                <p class="card-price">KES 1,050</p>
                <input type="hidden" name="product" value="breakfast">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/c3.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">chicken wings</h5>
                <p class="card-price">KES 2550</p>
                <input type="hidden" name="product" value="chicken wings">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/c4.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">pasta</h5>
                <p class="card-price">KES 3500</p>
                <input type="hidden" name="product" value="pasta">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/c5.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Tacos with Fries</h5>
                <p class="card-price">KES 1250</p>
                <input type="hidden" name="product" value="Tacos with Fries">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/c6.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">Breakfast dish</h5>
                <p class="card-price">KES 4,000</p>
                <input type="hidden" name="product" value="Breakfast dish">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/c7.jpeg" alt="Card image cap">
                </div>
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/c8.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">chicken alfredo</h5>
                <p class="card-price">KES 1500</p>
                <input type="hidden" name="product" value="chicken alfredo">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/c9.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">pasta</h5>
