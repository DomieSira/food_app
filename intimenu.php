...
<body>
    ...
    <div class="card-container">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/in9.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">inti1</h5>
                <p class="card-price">KES 1,000</p>
                <input type="hidden" name="product" value="inti1">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/in2.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">inti2</h5>
                <p class="card-price">KES 1,050</p>
                <input type="hidden" name="product" value="inti2">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/in1.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">inti3</h5>
                <p class="card-price">KES 2550</p>
                <input type="hidden" name="product" value="inti3">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/in4.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">inti4</h5>
                <p class="card-price">KES 3500</p>
                <input type="hidden" name="product" value="inti4">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/in5.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">inti5</h5>
                <p class="card-price">KES 1250</p>
                <input type="hidden" name="product" value="inti5">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/in7.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">inti6</h5>
                <p class="card-price">KES 4,000</p>
                <input type="hidden" name="product" value="inti6">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/in8.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">inti7</h5>
                <p class="card-price">KES 3,000</p>
                <input type="hidden" name="product" value="inti7">
        ...
        <form action="" method="post">
            <div class="card">
                ...
                <h5 class="card-title">inti8</h5>
                <p class="card-price">KES 1500</p>
                <input type="hidden" name="product" value="inti8">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/in10.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">int19</h5>
                <p class="card-price">KES 2,000</p>
                <input type="hidden" name="product" value="inti9">
