    ...
    <div class="card-container">
        ...
        <form action="" method="post">
            <div class="card">
                ...
                <input type="hidden" name="product" value="Gimbap">
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/images.jpeg" alt="Card image cap">
                </div>
                <h5 class="card-title">ttetoboki</h5>
                <p class="card-price">KES 1,000</p>
                <input type="hidden" name="product" value="ttetoboki">
                <input type="hidden" name="price" value="1000">
                <input type="number" value="1" min="1" class="quantity-input" name="quantity">
                <button type="submit" class="btn btn-primary add-to-cart-btn">Add to cart</button>
            </div>
        ...
        <form action="" method="post">
            <div class="card">
                ...
                <p class="card-price">KES 1,000</p>
                <input type="hidden" name="product" value="Rice">
                <input type="hidden" name="price" value="1000">
                <input type="number" value="1" min="1" class="quantity-input" name="quantity">
                <button type="submit" class="btn btn-primary add-to-cart-btn">Add to cart</button>
            </div>
        ...
        <form action="" method="post">
            <div class="card">
                ...
                <p class="card-price">KES 1,000</p>
                <input type="hidden" name="product" value="ramen">
                <input type="hidden" name="price" value="1000">
                <input type="number" value="1" min="1" class="quantity-input" name="quantity">
                <button type="submit" class="btn btn-primary add-to-cart-btn">Add to cart</button>
            </div>
        ...
        <form action="" method="post">
            <div class="card">
                ...
                <p class="card-price">KES 1,000</p>
                <input type="hidden" name="product" value="Japchae">
                <input type="hidden" name="price" value="1000">
                <input type="number" value="1" min="1" class="quantity-input" name="quantity">
                <button type="submit" class="btn btn-primary add-to-cart-btn">Add to cart</button>
            </div>
        ...
        <form action="" method="post">
            <div class="card">
                ...
                <input type="hidden" name="product" value="Fried rice">
                <input type="hidden" name="price" value="1000">
                <input type="number" value="1" min="1" class="quantity-input" name="quantity">
                <button type="submit" class="btn btn-primary add-to-cart-btn">Add to cart</button>
            </div>
        ...
        <form action="" method="post">
            <div class="card">
                ...
                <input type="hidden" name="product" value="tofu">
                <input type="hidden" name="price" value="1000">
                <input type="number" value="1" min="1" class="quantity-input" name="quantity">
                <button type="submit" class="btn btn-primary add-to-cart-btn">Add to cart</button>
            </div>
        ...
        <form action="" method="post">
            <div class="card">
                <div class="card-image">
                    <img src="images/koreanramen.jpg" alt="Card image cap">
                </div>
                <h5 class="card-title">Ramen</h5>
                <p class="card-price">KES 2000</p>
                <input type="hidden" name="product" value="Ramen">
                <input type="hidden" name="price" value="1000">
                <input type="number" value="1" min="1" class="quantity-input" name="quantity">
                <button type="submit" class="btn btn-primary add-to-cart-btn">Add to cart</button>
        ...
        <form action="" method="post">
            <div class="card">
                ...
                <h5 class="card-title">veggie ramen</h5>
                <p class="card-price">KES 2,000</p>
                <input type="hidden" name="product" value="Card title 1">
                <input type="hidden" name="price" value="1000">
                <input type="number" value="1" min="1" class="quantity-input" name="quantity">
                <button type="submit" class="btn btn-primary add-to-cart-btn">Add to cart</button>
            </div>
